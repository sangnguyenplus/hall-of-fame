        ...
        <div class="inner-border">
            ...
            <div class="content">
                ...
                <div class="verification-note"
                    style="text-align: center; margin-top: 10mm; padding: 5mm; background: rgba(45, 90, 135, 0.1); border-radius: 5px;">
            ...
            <div class="footer">
                ...
                <div class="footer-center">
                    ...
                    <div>
                        ...
                        {{ $certificate->discovery_date->format('M j, Y') }}
                    </div>
                    <div>
            ...
            @if (($settings['signature_required'] ?? false) && !empty($pgpSignature))
                <div class="pgp-signature-section">
                    <div class="signature-header">
                        🔐 {{ trans('plugins/hall-of-fame::certificates.certificate.signature.digital_signature') }}
                    </div>
                    <div class="signature-content">{{ $pgpSignature }}</div>
                    <div style="font-size: 6px; color: #666; margin-top: 2mm;">
            ...
            @if (($settings['include_qr_code'] ?? false) && !empty($qrCodeUrl))
                <div class="qr-code-section">
                    <div class="qr-code">
                        {{ trans('plugins/hall-of-fame::certificates.certificate.qr_code') }}
                    </div>
                    <div>{{ trans('plugins/hall-of-fame::certificates.certificate.details.verify') }}</div>
                    <div style="font-size: 6px;">{{ $qrCodeUrl }}</div>
                </div>
            @endif
        </div>
    </div>
