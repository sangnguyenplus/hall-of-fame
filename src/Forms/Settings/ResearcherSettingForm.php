...
class ResearcherSettingForm extends SettingForm
{
    public function setup(): void
    {
        ...
        $this
            ...
            ->add(
                'hall_of_fame_researcher_auto_approve',
                OnOffField::class,
            ...
            ->add(
                'hall_of_fame_researcher_require_verification',
                OnOffField::class,
                OnOffFieldOption::make()
            ...
            ->add(
                'hall_of_fame_researcher_email_notifications',
                OnOffField::class,
                OnOffFieldOption::make()
            ...
            ->add(
                'hall_of_fame_researcher_public_profiles',
                OnOffField::class,
                OnOffFieldOption::make()
            ...
            ->add(
                'hall_of_fame_researcher_default_status',
                SelectField::class,
